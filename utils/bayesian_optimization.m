function [action_best,MI_best] = BKI_optimization(candidate_list,X_train,Y_train,L, Hm_0, sensor, param, MI_update_list)
%{  
...
for i = 1:n_epoch
    ...
    if flag_not_in
        % explicitly eval candidate_with_max_acq MI 
        MI_best_epoch = action_MI(candidate_with_max_acq, L, Hm_0, sensor, param);     
        action_best = [action_best; candidate_with_max_acq];
